...
namespace Fibula.Server.Mechanics.Handlers
{
    ...
    /// </summary>
    public class RotateItemHandler : BaseTcpRequestHandler
    {
        /// <summary>
        ...
        public RotateItemHandler(ILogger<RotateItemHandler> logger, ITcpServerInstance tcpServerInstance)
            : base(logger, tcpServerInstance)
        {
        }
