// -----------------------------------------------------------------
// <copyright file="ContainerItemUpdatedNotification.cs" company="2Dudes">
...
namespace Fibula.Server.Notifications
{
    ...
    /// <summary>
    /// Class that represents a notification for when an item is updated in a container.
    /// </summary>
    public class ContainerItemUpdatedNotification : Notification
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContainerItemUpdatedNotification"/> class.
        /// </summary>
        ...
        public ContainerItemUpdatedNotification(Func<IEnumerable<IPlayer>> findTargetPlayers, byte containerId, IItem item)
        ...
        public override bool Post(INotificationContext context, IPlayer player)
        {
            ...
            {
                ContainerUpdateItem = new ContainerUpdateItem()
                {
