        ...
        private void PerformAttack(IOperationContext context)
        {
            ...
            if (damageDoneInfo.Damage != 0)
            {
                ...
                else if (this.Target is IPlayer tgtPlayer)
                {
                    ...
                    this.SendNotification(context, new TextMessageNotification(tgtPlayer.YieldSingleItem(), MessageType.Status, hitpointsLostMessage));
                }
            ...
            {
                // TODO: actual projectile type value here.
            ...
            if (this.Attacker != null)
            {
                ...
                {
                    // TODO: increase the actual skill of the weapon used.
            ...
            if (this.Target is IPlayer targetPlayer)
            {
                if (this.Attacker != null)
                {
                    this.SendNotification(context, new SquareNotification(targetPlayer, this.Attacker.Id, SquareColor.Black));
                }
