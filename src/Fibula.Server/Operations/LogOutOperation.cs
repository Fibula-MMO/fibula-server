...
namespace Fibula.Server.Operations
{
    ...
    public class LogOutOperation : Operation
    {
        ...
        protected override void Execute(IOperationContext context)
        {
            ...
            // TODO: check for In-fight condition
            ...
            */
            ...
            if (!context.Map.HasTileAt(this.Player.Location, out ITile tile))
            {
                return;
            }
            ...
            var spectators = context.Map.FindPlayersThatCanSee(playerLocation);
            ...
            if (removedFromMap || this.Player.IsDead)
            {
                ...
                {
                    this.SendNotification(context, new MagicEffectNotification(spectators, playerLocation, AnimatedEffect.Puff));
                }

                this.SendNotification(context, new PlayerLogoutNotification(this.Player));
