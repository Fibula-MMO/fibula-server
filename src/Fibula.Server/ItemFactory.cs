...
namespace Fibula.Server.Items
{
    ...
    public class ItemFactory : IItemFactory
    {
        ...
        /// </summary>
        public event ItemFactoryItemCreatedHandler ItemCreated;
        ...
        /// </summary>
        /// <param name="itemCreationArguments">The arguments to use to create the item.</param>
        /// <returns>The new <see cref="IItem"/> instance.</returns>
        public IItem CreateItem(IItemCreationArguments itemCreationArguments)
        {
            ...
            if (itemType == null)
            {
                throw new ArgumentException($"Unknown item type with Id {itemCreationArguments.TypeId} in creation arguments for an item.", nameof(itemCreationArguments));
            }
