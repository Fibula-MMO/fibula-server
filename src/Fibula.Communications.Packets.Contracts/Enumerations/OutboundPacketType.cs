// -----------------------------------------------------------------
// <copyright file="OutboundPacketType.cs" company="2Dudes">
...
namespace Fibula.Communications.Packets.Contracts.Enumerations
{
    /// <summary>
    /// Enumerates the different outbound packet types.
    /// </summary>
    public enum OutboundPacketType : byte
    {
        /// <summary>
