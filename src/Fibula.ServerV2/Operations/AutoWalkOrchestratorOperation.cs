...
namespace Fibula.ServerV2.Operations
{
    ...
    public class AutoWalkOrchestratorOperation : Operation
    {
        ...
        protected override void Execute(IOperationContext context)
        {
            ...
            {
                var (result, _, directions) = context.PathFinder.FindPathBetween(this.Creature.Location, this.Creature.WalkPlan.GetGoalLocation(), this.Creature, targetDistance: this.Creature.WalkPlan.GoalTargetDistance);
            ...
            this.RepeatAfter = this.Creature.CalculateStepDuration(context.Map[this.Creature.Location]);
        }
    }
}
