...
namespace Fibula.Communications.Packets.Incoming
{
    ...
    /// </summary>
    public sealed class HeartbeatResponsePacket : IInboundPacket, IActionWithoutContentInfo
    {
        /// <summary>
        /// Gets the action to do.
        /// </summary>
        public InboundPacketType Action => InboundPacketType.HeartbeatResponse;
    }
}
