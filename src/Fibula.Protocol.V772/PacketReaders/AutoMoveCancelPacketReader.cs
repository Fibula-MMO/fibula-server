// -----------------------------------------------------------------
// <copyright file="AutoMoveCancelPacketReader.cs" company="2Dudes">
...
namespace Fibula.Protocol.V772.PacketReaders
{
    ...
    /// <summary>
    /// Class that represents an auto move cancellation packet reader for the game server.
    /// </summary>
    public sealed class AutoMoveCancelPacketReader : BasePacketReader
    {
        /// <summary>
        ...
        public override IIncomingPacket ReadFromMessage(INetworkMessage message)
        {
            ...
            // Nothing to read!
            return new AutoMoveCancelPacket();
        }
    }
}
