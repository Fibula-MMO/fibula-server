// -----------------------------------------------------------------
// <copyright file="WalkSouthwestPacketReader.cs" company="2Dudes">
...
namespace Fibula.Protocol.V772.PacketReaders
{
    ...
    /// </summary>
    public sealed class WalkSouthwestPacketReader : BasePacketReader
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalkSouthwestPacketReader"/> class.
        /// </summary>
        /// <param name="logger">A reference to the logger in use.</param>
        public WalkSouthwestPacketReader(ILogger<WalkSouthwestPacketReader> logger)
            : base(logger)
        {
        }
        ...
        public override IInboundPacket ReadFromMessage(INetworkMessage message)
        {
            ...
            return new WalkOnDemandPacket(Direction.SouthWest);
        }
    }
}
