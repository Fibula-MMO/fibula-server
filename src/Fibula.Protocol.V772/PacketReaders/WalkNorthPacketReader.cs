// -----------------------------------------------------------------
// <copyright file="WalkNorthPacketReader.cs" company="2Dudes">
...
namespace Fibula.Protocol.V772.PacketReaders
{
    ...
    /// <summary>
    /// Class that represents a walk north packet reader for the game server.
    /// </summary>
    public sealed class WalkNorthPacketReader : BasePacketReader
    {
        /// <summary>
        ...
        public override IInboundPacket ReadFromMessage(INetworkMessage message)
        {
            ...
            return new WalkOnDemandPacket(Direction.North);
        }
    }
}
