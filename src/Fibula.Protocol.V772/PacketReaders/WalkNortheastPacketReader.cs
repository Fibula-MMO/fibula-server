// -----------------------------------------------------------------
// <copyright file="WalkNortheastPacketReader.cs" company="2Dudes">
...
namespace Fibula.Protocol.V772.PacketReaders
{
    ...
    /// </summary>
    public sealed class WalkNortheastPacketReader : BasePacketReader
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalkNortheastPacketReader"/> class.
        /// </summary>
        /// <param name="logger">A reference to the logger in use.</param>
        public WalkNortheastPacketReader(ILogger<WalkNortheastPacketReader> logger)
            : base(logger)
        {
        }
