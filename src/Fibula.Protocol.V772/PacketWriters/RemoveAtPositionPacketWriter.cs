// -----------------------------------------------------------------
// <copyright file="RemoveAtPositionPacketWriter.cs" company="2Dudes">
...
namespace Fibula.Protocol.V772.PacketWriters
{
    ...
    /// </summary>
    public class RemoveAtPositionPacketWriter : BasePacketWriter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveAtPositionPacketWriter"/> class.
        /// </summary>
        /// <param name="logger">A reference to the logger in use.</param>
        public RemoveAtPositionPacketWriter(ILogger logger)
            : base(logger)
        {
        }
        ...
        {
            if (packet is not RemoveAtLocationPacket removeAtPositionPacket)
            {
