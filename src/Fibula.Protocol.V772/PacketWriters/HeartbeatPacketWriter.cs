// -----------------------------------------------------------------
// <copyright file="HeartbeatPacketWriter.cs" company="2Dudes">
...
namespace Fibula.Protocol.V772.PacketWriters
{
    ...
    /// </summary>
    public class HeartbeatPacketWriter : BasePacketWriter
    {
        /// <summary>
        ...
        public override void WriteToMessage(IOutboundPacket packet, ref INetworkMessage message)
        {
            ...
            message.AddByte(heartbeatPacket.PacketType.ToByte());
        }
    }
}
