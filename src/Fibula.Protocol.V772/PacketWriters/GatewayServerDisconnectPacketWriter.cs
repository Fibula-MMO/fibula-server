...
namespace Fibula.Protocol.V772.PacketWriters
{
    ...
    public class GatewayServerDisconnectPacketWriter : BasePacketWriter
    {
        ...
        public GatewayServerDisconnectPacketWriter(ILogger<GatewayServerDisconnectPacketWriter> logger)
            : base(logger)
        {
        }
        ...
        public override void WriteToMessage(IOutboundPacket packet, ref INetworkMessage message)
        {
            ...
            message.AddByte(loginServerDisconnectPacket.PacketType.ToByte());
