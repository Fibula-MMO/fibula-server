// -----------------------------------------------------------------
// <copyright file="SentientCreatureCreatureLostHandler.cs" company="2Dudes">
...
namespace Fibula.Server.Contracts.Delegates
{
    ...
    public delegate void SentientCreatureCreatureLostHandler(ISentientCreature creature, ICreature creatureLost);
}
