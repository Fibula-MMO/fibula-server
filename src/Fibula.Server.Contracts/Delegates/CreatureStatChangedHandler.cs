// -----------------------------------------------------------------
// <copyright file="CreatureStatChangedHandler.cs" company="2Dudes">
...
namespace Fibula.Server.Contracts.Delegates
{
    ...
    public delegate void CreatureStatChangedHandler(ICreature creature, IStat statThatChanged, uint previousValue, byte previousPercent);
}
