// -----------------------------------------------------------------
// <copyright file="CombatantAttackTargetChangedHandler.cs" company="2Dudes">
...
namespace Fibula.Server.Contracts.Delegates
{
    ...
    public delegate void CombatantAttackTargetChangedHandler(ICombatant combatant, ICombatant oldTarget);
}
