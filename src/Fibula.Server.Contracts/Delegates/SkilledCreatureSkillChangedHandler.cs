// -----------------------------------------------------------------
// <copyright file="SkilledCreatureSkillChangedHandler.cs" company="2Dudes">
...
namespace Fibula.Server.Contracts.Delegates
{
    ...
    public delegate void SkilledCreatureSkillChangedHandler(ISkilledCreature skilledCreature, ISkill skillThatChanged, uint previousLevel, byte previousPercent, long? countDelta = null);
}
