...
namespace Fibula.Mechanics.Handlers
{
    ...
    /// </summary>
    public sealed class AttackHandler : GameHandler
    {
        /// <summary>
        ...
        public AttackHandler(ILogger<AttackHandler> logger, IGame gameInstance, ICreatureFinder creatureFinder)
        ...
        public override IEnumerable<IOutboundPacket> HandleRequest(IIncomingPacket incomingPacket, IClient client)
        {
            ...
            if (incomingPacket is not IAttackInfo attackInfo)
            {
